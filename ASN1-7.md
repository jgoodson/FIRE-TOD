...
You'll notice our Ensemble IDs are found in an unlabeled column before the 6 named data columns. This is because these are the row names for this table. We can access these directly with the `rownames()` function. 
